...
MidelePowerDescription:
	db   "Crush the foe"
	feed "for 2-5 turns.@"
DarkThunderDescription:
	db   "Throws sparks that"
...
IcyWindDescription:
	...
	feed "may lowers SPEED.@"
BraveBirdDescription:
	db   "A tackle that also"
	feed "hurts the user.@"
HolaReinaDescription:
	db   "The user's level"
