...
; set target's sleep counter to a random number between 0 and 3
	call BattleRandom
	and $3; sleep should now last 0, 1, 2, or 3 turns
...
.statModifierDownEffect
	...
	jr c, .nonSideEffect
; NUEVO PARA QUE EFECTOS DE BAJADA DE STATS (ACID, BUBBLEBEAM, ICY WIND, AURORA BEAM) SEAN DEL 33.2% Y QUE LOS EFECTOS (SPECIAL_DOWN_SIDE_EFFECT COMO PSYCHIC) SEAN 10%
